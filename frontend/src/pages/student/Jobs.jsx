...
import FilterDrawer from '../../components/FilterDrawer' // Mobile slide-in
import FilterSidebar from '../../components/FilterSidebar' // Desktop sidebar
        ...
        <div className="flex items-center justify-between mb-3 sm:mb-6">
          ...
          <div className="flex items-center gap-1 sm:gap-2 w-full sm:w-auto">
            ...
            <button
              ...
              className="md:hidden flex items-center gap-1 bg-white border border-gray-200 rounded-xl px-2 py-1.5 shadow-sm text-xs text-gray-700 flex-shrink-0"
            >
...
// import Navbar from '../../components/shared/Navbar'
// import JobCard from '../../components/job/JobCard'
// import FilterCard from '../../components/FilterDrawer'
// import { useDispatch, useSelector } from 'react-redux';
// import { setSearchJobByText } from '@/redux/jobSlice';
// import left from "../../assets/left.png";
// import right from "../../assets/right.png";
...
//             <button
//               onClick={() => setShowFilters(true)}
//               className="md:hidden flex items-center gap-1 bg-white border border-gray-200 rounded-xl px-2 py-1.5 sm:px-3 sm:py-2 shadow-sm text-xs text-gray-700 flex-shrink-0"
//             >
//               <Filter size={14} /> Filters
//             </button>

//             <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-2 py-1.5 sm:px-3 sm:py-2 shadow-sm flex-1 sm:flex-none sm:w-64">
//               <Search size={14} className="text-gray-400 flex-shrink-0" />
//               <input
//                 type="text"
//                 placeholder="Search jobs..."
