...
const filterSections = [
  { title: 'Location', key: 'location', options: ['Delhi', 'Bangalore', 'Mumbai', 'Hyderabad', 'Pune', 'Remote', 'NCR', 'Chennai', 'Gurgaon', 'Noida', 'Kolkata'] },
  { title: 'Profile', key: 'profile', options: ['Software Development', 'Web Development', 'Data Science', 'Marketing', 'Design', 'Finance', 'HR', 'Content Writing', 'Business Development', 'Operations'] },
  { title: 'Stipend', key: 'stipend', options: ['Unpaid', '0-5k', '5k-10k', '10k-20k', '20k-50k', '50k+'] },
  { title: 'Duration', key: 'duration', options: ['1 Month', '2 Months', '3 Months', '6 Months', '1 Year'] },
  { title: 'Mode', key: 'mode', options: ['Remote', 'In-office', 'Hybrid'] }
];

const InternshipFilterDrawer = ({ isOpen, onClose }) => {
              ...
              <div key={section.key} className="mb-1">
                ...
                >
                  <div>
                    ...
                    {selected && <span className="text-[11px] text-indigo-500">{selected}</span>}
                  </div>
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex justify-between text-left px-3 py-2.5 rounded-lg text-sm ${
                            isSelected ? 'bg-indigo-600 text-white' : 'text-gray-600 hover:bg-gray-100'
                          }`}
                        >
                          {option}
