...
const InternshipCard = ({ internship }) => {
  ...
  return (
    <div className="bg-white rounded-xl border p-4 flex flex-col gap-3 hover:shadow-md transition">
      ...
      <div>
        <h2 className="text-sm font-semibold text-gray-900">{internship?.title}</h2>
...
// import { useDispatch, useSelector } from "react-redux";
// import { toggleSavedInternship } from "@/redux/savedJobSlice";
// import { INTERNSHIP_API_END_POINT, JOB_API_END_POINT, SAVED_API_END_POINT } from "@/utils/constant";
...
//       console.log("apply");
//       if(res.data.success){
//         dispatch(`/internship/${internship._id}`)
//       }
//     } catch (error) {
//       console.log(error);
//     }
