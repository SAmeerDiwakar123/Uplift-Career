...
import { MapPin, Briefcase, DollarSign, Clock, Monitor, Check, X } from 'lucide-react';
import { useDispatch, useSelector } from 'react-redux';
import { clearFilter, setFilters } from '@/redux/internshipSlice';

const filterSections = [
  { icon: <MapPin size={16} />, title: 'Location', key: 'location', options: ['Delhi', 'Bangalore', 'Mumbai', 'Hyderabad', 'Pune', 'Remote', 'NCR', 'Chennai', 'Gurgaon', 'Noida', 'Kolkata'] },
  { icon: <Briefcase size={16} />, title: 'Profile', key: 'profile', options: ['Software Development', 'Web Development', 'Data Science', 'Marketing', 'Design', 'Finance', 'HR', 'Content Writing', 'Business Development', 'Operations'] },
  { icon: <DollarSign size={16} />, title: 'Stipend', key: 'stipend', options: ['Unpaid', '0-5k', '5k-10k', '10k-20k', '20k-50k', '50k+'] },
  { icon: <Clock size={16} />, title: 'Duration', key: 'duration', options: ['1 Month', '2 Months', '3 Months', '6 Months', '1 Year'] },
  { icon: <Monitor size={16} />, title: 'Mode', key: 'mode', options: ['Remote', 'In-office', 'Hybrid'] },
];

const InternshipFilterMegaDropdown = ({ isOpen, onClose }) => {
...
export default InternshipFilterMegaDropdown;