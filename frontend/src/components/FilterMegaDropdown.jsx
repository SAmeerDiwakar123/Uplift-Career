...
//       {/* Mega Dropdown Panel */}
//       <div
//         className="absolute left-1/2 -translate-x-1/2 top-16 w-full max-w-2xl bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden"
//         onClick={(e) => e.stopPropagation()}
//       >
//         <div className="flex h-[380px]">
//           {/* Left: Filter Categories */}
//           <div className="w-2/5 bg-gray-50/80 border-r border-gray-100 py-2">
//             {filterSections.map((section, index) => {
//               const isActive = activeIndex === index;
//               const hasValue = filters[section.key];
...
//                   )}
//                   {isActive && (
//                     <div className="absolute right-0 top-1/2 -translate-y-1/2 w-0.5 h-6 bg-indigo-600 rounded-l-full" />
//                   )}
//                 </button>
//               );
//             })}
...
// // Navbar mein use karo
// const NavbarWithFilterDropdown = () => {
...
//           <a href="/" className="font-bold text-xl text-indigo-600">YourLogo</a>
          
//           <div className="flex items-center gap-1">
//             <button
//               className={`flex items-center gap-1 px-3 py-2 text-sm font-medium rounded-lg transition ${
//                 openDropdown ? 'text-indigo-600 bg-indigo-50' : 'text-gray-700 hover:text-indigo-600'
//               }`}
...
// export { FilterMegaDropdown, NavbarWithFilterDropdown };