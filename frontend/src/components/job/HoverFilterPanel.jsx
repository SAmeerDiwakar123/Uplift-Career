...
const HoverFilterPanel = ({ filters, onFilterChange, onClearAll }) => {
  ...
  const [searchTerm, setSearchTerm] = useState(''); // 🌟 इन-फ़िल्टर सर्च के लिए स्टेट
  ...
  // जब भी ड्रॉपडाउन बदलेगा, अंदर की सर्च टर्म रीसेट हो जाएगी
  useEffect(() => {
    setSearchTerm('');
  }, [openDropdown]);
        ...
        <div className="max-w-7xl mx-auto px-3">
          ...
          <div className="flex items-center gap-2 py-2 flex-wrap">
            {filterConfig.map((section) => {
              ...
              // 🌟 ऑप्शंस को अंदर ही सर्च फ़िल्टर करना
