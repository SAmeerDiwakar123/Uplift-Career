...
//   return (
//     <div className='bg-[#111827] shadow-sm py-4 sticky top-0 z-50 border-b border-gray-200'>
...
//             ) : user.role === 'recruiter' ? (
//               <>
//                 <Link to="/admin/dashboard" className="text-gray-200 hover:text-blue-400 cursor-pointer transition">
//                   Dashboard
//                 </Link>
//                 <Link to="/admin/add-jobs" className="text-gray-200 hover:text-blue-400 cursor-pointer transition">
//                   Add Job
//                 </Link>
//                 <Link to="/admin/manage-jobs" className="text-gray-200 hover:text-blue-400 cursor-pointer transition">
//                   Manage Jobs
//                 </Link>
//                 <Link to="/admin/create-company" className="text-gray-200 hover:text-blue-400 cursor-pointer transition">
//                   Create Company
//                 </Link>
//                 <Link to="/admin/companies" className="text-gray-200 hover:text-blue-400 cursor-pointer transition">
//                   Companies
//                 </Link>
//               </>
//             ) : (
//               <>
//                 <NavLink to="/internship" className="text-gray-200 hover:text-blue-400 cursor-pointer transition">Internship</NavLink>
//                 <NavLink to="/jobs" className="text-gray-200 hover:text-blue-400 cursor-pointer transition">Jobs</NavLink>
//                 <NavLink to="/saved" className="text-gray-200 hover:text-blue-400 cursor-pointer transition">Saved Jobs</NavLink>
//                 <NavLink to="/applications" className="text-gray-200 hover:text-blue-400 cursor-pointer transition">Applications</NavLink>
//                 <NavLink to="/courses" className="text-gray-200 hover:text-blue-400 cursor-pointer transition">Courses</NavLink>
//               </>
//             )
//           }
//         </div>
...
//                       <div className='flex items-center gap-2 px-2 py-2 rounded-lg cursor-pointer hover:bg-red-50'>
//                         <LogOut className='w-4 h-4' />
//                         <Button onClick={logoutHandler} variant="link" size="sm" className='p-0 h-auto text-red-500'>
//                           Logout
//                         </Button>
//                       </div>
