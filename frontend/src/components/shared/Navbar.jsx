      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-3.5">
        <div className="flex items-center justify-between">
          ...
          <div onClick={() => navigate('/')} className="flex items-center gap-2 cursor-pointer">
            <img src={logo} alt="Uplift Career" className="h-7 sm:h-9" />
          </div>

          {/* Desktop Navigation — Public links only, big screen pe dikhe */}
          ...
          <div className="flex items-center gap-2">
            {!user ? (
              <div className="flex items-center gap-2">
                <Link to="/login">
                  <button className="text-slate-400 text-sm px-3 py-1.5 rounded-lg hover:text-slate-200 transition-colors">
                    Login
                  </button>
                </Link>
                <Link to="/signup">
                  <button className="bg-blue-600 text-white text-sm px-4 py-1.5 rounded-lg hover:bg-blue-500 transition-colors font-medium">
                    Get Started
                  </button>
                </Link>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="hidden md:flex items-center gap-1.5 text-sm text-red-400 hover:text-red-300 px-3 py-1.5 rounded-lg hover:bg-red-950/20 transition-colors"
                >
                  <LogOut size={15} />
                  Logout
                </button>
                ...
                <button
                  onClick={logoutHandler}
                  className="md:hidden text-slate-400 hover:text-red-400 transition-colors p-1.5"
                  aria-label="Logout"
                >
                  <LogOut size={20} />
                </button>
