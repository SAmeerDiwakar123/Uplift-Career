...
import {
  Bookmark, LogOut, User2, Briefcase, GraduationCap, LayoutDashboard, Building2,
  PlusCircle, ListChecks, Home, Info, Phone, Bell,
  LayoutDashboardIcon, Settings
} from "lucide-react";
...
const Navbar = () => {
  // 1️⃣ SAARE HOOKS TOP PAR DECLARE HOONGE
  ...
  // 2️⃣ SAARE HOOKS KE BAAD EARLY RETURN CONDITION AAYEGI
  ...
  const getNavItems = () => {
    ...
    if (user.role === "admin") {
      return [
        ...
        { path: '/admin/recruiters', label: 'Recruiters', icon: User2 },
                  ...
                  <div className="absolute right-0 top-12 w-52 bg-slate-900 border border-slate-800 rounded-xl">
                    ...
                    <div className="p-2 flex flex-col gap-1">
                      {user.role === "student" && (
                        <>
                          <button
                            ...
                            className="flex gap-2 items-center w-full px-3 py-2 text-slate-300 hover:bg-slate-800 rounded-lg text-sm"
                          >
                            <User2 size={15} />
                            Profile
                          </button>
                          <button 
                            ...
                            className='flex gap-2 items-center w-full px-3 py-2 text-emerald-400 hover:bg-emerald-950/50 rounded-lg text-sm'
                          >
                      ...
                      <button
                        ...
                        className="flex gap-2 items-center w-full px-3 py-2 text-red-400 hover:bg-red-950/50 rounded-lg text-sm"
                      >
                        <LogOut size={15} />
                        Logout
                      </button>
